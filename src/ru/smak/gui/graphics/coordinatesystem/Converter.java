...
class Converter {
     ...
     */
    int xCrt2Scr(double x, CartesianScreenPlane plane) {
     ...
     */
    double xScr2Crt(int x, CartesianScreenPlane plane) {
     ...
     */
    int yCrt2Scr(double y, CartesianScreenPlane plane) {
     ...
     */
    double yScr2Crt(int y, CartesianScreenPlane plane){
