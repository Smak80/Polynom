package ru.smak.gui.graphics.coordinatesystem;
...
class Converter {
     ...
     */
    static int xCrt2Scr(double x, CartesianScreenPlane plane) {
     ...
     */
    static double xScr2Crt(int x, CartesianScreenPlane plane) {
     ...
     */
    static int yCrt2Scr(double y, CartesianScreenPlane plane) {
     ...
     */
    static double yScr2Crt(int y, CartesianScreenPlane plane){
